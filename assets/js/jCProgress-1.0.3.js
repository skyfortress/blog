 	...
 	$.ns.cprogress = function ( el, options) {
	  ...
	  base.methods = {
	  	init: function () {
			...
			if(base.options.text!=false){
				base.$text = $('<div />').addClass('skill-text');
				base.$text.text(base.options.text);
				base.$progress.prepend(base.$text);
			}
...
$.ns.cprogress.defaultOptions = {
    ...
    img1: 'images/skill_bg.png', // background
    img2: 'images/skill.png', // foreground
    speed: 7, // speed (timeout)
